...
from keras import activations, callbacks, losses, metrics, optimizers, utils, Model
...
if __name__ == "__main__":
    ...
    # Create 3DCNN model
    logger.info("Creating 3DCNN model...")
    cnn_3d = create_3DCNN_model()
